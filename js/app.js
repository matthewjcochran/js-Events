...
var menuItems = ['hash brown', 'coffee', 'french fries'];
...
function addRandom() {
    ...
    displayQuotes.innerHTML = quotes[i];
}
...
showHide.addEventListener('click', showOrHide);

function showOrHide() {
    if(showmoney.style.display !== 'inline'){
